...
public class OrderProductService {
    ...
    public List<OrderProduct> getOrderProductAll(){
        String dql ="SELECT op.id_order_product,op.id_product,op.id_order,op.how_many,op.price, o.id_order, o.id_user, o.order_date, o.country, o.city, o.home_number, o.zip_code, o.phone_number, o.e_mail, o.order_status, o.is_paid, o.total_price, o.discount,p.id_product,p.id_category,p.name,p.producer, p.description, p.price, p.imagePath, p.how_many FROM order_product op INNER JOIN orders o ON op.id_order = o.id_order INNER JOIN product p ON op.id_product = p.id_product;";
    ...
    public OrderProduct getOrderProductOne(int id){
        String dql =String.format("SELECT op.id_order_product,op.id_product,op.id_order,op.how_many,op.price, o.id_order, o.id_user, o.order_date, o.country, o.city, o.home_number, o.zip_code, o.phone_number, o.e_mail, o.order_status, o.is_paid, o.total_price, o.discount,p.id_product,p.id_category,p.name,p.producer, p.description, p.price, p.imagePath, p.how_many FROM order_product op INNER JOIN orders o ON op.id_order = o.id_order INNER JOIN product p ON op.id_product = p.id_product WHERE op.id_order_product=%d;",id);
        return this.databaseService.performSQL(dql, resultSet -> {
            try {
                if(resultSet.next()) {
                    Product product = new ProductBuilder()
    ...
    public void updateOrderProduct(OrderProduct orderProduct) {
            String dml = String.format(Locale.US,"UPDATE order_product SET id_product = %d, id_order = %d, how_many = %d, price = %f WHERE id_order_product= %d;", orderProduct.getIdProduct(), orderProduct.getIdOrder(), orderProduct.getHowMany(), orderProduct.getPrice(), orderProduct.getIdOrderProduct());
            this.databaseService.performDML(dml);
    }
    ...
    public List<OrderProduct> getUserOrderProductById(int id){
        String dql =String.format("SELECT op.id_order_product,op.id_product,op.id_order,op.how_many,op.price, o.id_order, o.id_user, o.order_date, o.country, o.city, o.home_number, o.zip_code, o.phone_number, o.e_mail, o.order_status, o.is_paid, o.total_price, o.discount,p.id_product,p.id_category,p.name,p.producer, p.description, p.price,p.imagePath, p.how_many FROM order_product op INNER JOIN orders o ON op.id_order = o.id_order INNER JOIN product p ON op.id_product = p.id_product  WHERE o.id_order=%d;",id);
        return this.databaseService.performSQL(dql, resultSet -> {
            try {
                List<OrderProduct> orderProductList = new ArrayList<>();
                while (resultSet.next()){
